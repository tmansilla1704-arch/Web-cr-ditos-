          ...
          {animationPhase === 'games' ? (
            <div key="games-phase" className="animate-slide-right flex flex-col gap-3">
              <div className="text-center pt-1">
                <span className="text-[10px] font-extrabold uppercase tracking-widest text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 px-3 py-1 rounded-full border border-blue-100 dark:border-blue-
